...
def generate_srt(video_path):
    ...
    # save result as json for debugging
    import json
    with open("debug_result.json", "w", encoding="utf-8") as jf:
        json.dump(res, jf, ensure_ascii=False, indent=4)
...
if __name__ == "__main__":
    ...
    generate_srt("input/4k25_16000.wav")